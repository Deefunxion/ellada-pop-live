  ...
  return (
    <div className="rounded-lg border border-border bg-card/40 p-4 sm:p-6">
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Επίσημες απογραφές 1828–2021 και εκτίμηση 1.1.2025. Έως το 2001
        μετριέται ο de facto πληθυσμός, από το 2011 ο μόνιμος — μέρος της
        πτώσης 2001→2011 οφείλεται στην αλλαγή μεθοδολογίας.
      </p>
...
function VitalChart() {
  ...
  return (
    <div className="rounded-lg border border-border bg-card/40 p-4 sm:p-6">
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Πλήρης επίσημη σειρά ΕΛΣΤΑΤ. Το κενό 1941–1954 είναι πραγματικό: δεν
        υπάρχουν δημοσιευμένα στοιχεία (Κατοχή, Εμφύλιος). Μεμονωμένα αρνητικά
        έτη εμφανίστηκαν το 1996 και 1998–2003· από το 2011 η φυσική μείωση
        είναι αδιάλειπτη.
      </p>
      <div className="mt-4 h-[300px] sm:h-[380px]">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data} margin={{ top: 8, right: 16, bottom: 0, left: 8 }}>
            ...
            <ReferenceLine
              ...
              strokeDasharray="4 4"
              label={{
                value: `${CROSSOVER_YEAR}: Οι θάνατοι ξεπερνούν μόνιμα τις γεννήσεις`,
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <ul className="mt-2 space-y-1">
                <li>ΕΛΣΤΑΤ — Απογραφές Πληθυσμού 1821–2021 (λεύκωμα)</li>
                <li>ΕΛΣΤΑΤ — Φυσική Κίνηση Πληθυσμού 1932–2024 (SPO03)</li>
                <li>
                  ΕΛΣΤΑΤ — Εκτιμώμενος Πληθυσμός 1.1.2025 & Μεταναστευτικές
                  Ροές 2024 (18.12.2025)
                </li>
                <li>Eurostat — demo_pjan (διασταύρωση, ενημ. 03.07.2026)</li>
              </ul>
            </div>
            <div className="sm:text-right">
              ...
              <p className="mt-2">
                Τα στοιχεία 2011–2024 ακολουθούν την αναθεωρημένη σειρά της
                ΕΛΣΤΑΤ (Δεκ. 2025). Οι τιμές παλαιών απογραφών εκκρεμούν προς
                επιβεβαίωση από το πρωτογενές λεύκωμα.
              </p>
            </div>
          </div>
